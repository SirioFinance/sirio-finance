...
library FixedPoint {
    ...
    function muluq(
        ...
        require(sum <= uint224(-int224(1)), "FixedPoint: MULUQ_OVERFLOW_SUM");
    ...
    function divuq(
        ...
        if (self._x <= uint144(-int144(1))) {
            ...
            require(value <= uint224(-int224(1)), "FixedPoint: DIVUQ_OVERFLOW");
            return uq112x112(uint224(value));
        }

        uint256 result = FullMath.mulDiv(Q112, self._x, other._x);
        require(result <= uint224(-int224(1)), "FixedPoint: DIVUQ_OVERFLOW");
